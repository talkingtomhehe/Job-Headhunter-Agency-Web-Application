...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 28, 2025 lúc 09:04 PM
...
(2, 3, 'MoMo', 'Phu My Hung Tower - 8 Hoang Van Thai St., Tan Phu Ward, Dist.7, HCMC, Ho Chi Minh City, Ho Chi Minh 70000, VN', 'EMBRACE YOUR SUCCESS', 'uploads/company_logos/company_2_1744736136.png', '2025-04-11 17:25:25', '2025-04-28 18:30:32', 'https://www.momo.vn/', '', 'Financial Services'),
...
INSERT INTO `job_applications` (`application_id`, `job_id`, `seeker_id`, `applicant_full_name`, `applicant_email`, `applicant_phone`, `status`, `admin_status`, `resume_path`, `cover_letter`, `employer_notes`, `created_at`, `updated_at`, `interview_date`, `interview_location`, `source`) VALUES
(2, 2, 8, 'John Applicant', 'applicant1@example.com', '0987123456', 'pending', 'approved', 'uploads/resumes/resume_680fb6390ccb6.pdf\r\n', 'Tôi có kinh nghiệm làm việc với Laravel và các framework PHP...', NULL, '2025-04-11 17:25:25', '2025-04-28 18:51:28', NULL, NULL, 'direct'),
(3, 3, 9, 'Jane Applicant', 'applicant2@example.com', '0987123457', 'shortlisted', 'approved', 'uploads/resumes/resume_680fb6390ccb6.pdf\r\n', 'Tôi đam mê phát triển ứng dụng di động và mong muốn được học hỏi tại MoMo...', NULL, '2025-04-11 17:25:25', '2025-04-28 18:51:39', NULL, NULL, 'direct'),
(4, 4, 9, 'Jane Applicant', 'applicant2@example.com', '0987123457', 'pending', 'approved', 'uploads/resumes/resume_680fb6390ccb6.pdf\r\n', 'Tôi mong muốn được tham gia vào đội ngũ phát triển của MoMo...', NULL, '2025-04-11 17:25:25', '2025-04-28 18:51:51', NULL, NULL, 'direct');
...
(51, 3, 'Job Post Rejected', 'Your job posting \"Team Leader - IT Business Analyst, Securities\" has been rejected. Please review and update it before resubmitting.', 'approval', 11, 0, '2025-04-28 01:46:15'),
(52, 3, 'Job Post Rejected', 'Your job posting \"Java Developer\" has been rejected. Please review and update it before resubmitting.', 'approval', 10, 0, '2025-04-28 01:46:20'),
(53, 3, 'New Application Available', 'A new application from Guest Applicant for \"Software Engineer (Backend Skill)\" is available for review.', 'application', 10, 0, '2025-04-28 02:26:54'),
(54, 3, 'New Application Available', 'A new application from Nguyen Van A for \"Software Engineer (Backend Skill)\" is available for review.', 'application', 11, 0, '2025-04-28 03:21:53'),
(55, 9, 'Application Rejected', 'Your application for \"(Senior) Fullstack Developer, ReactJS & .NET\" has been rejected by admin.', '', 4, 0, '2025-04-28 17:25:40'),
(56, 9, 'Application Approved', 'Your application for \"(Senior) Fullstack Developer, ReactJS & .NET\" has been approved by admin.', 'approval', 4, 0, '2025-04-28 17:53:48'),
(57, 3, 'New Application Available', 'A new application from Jane Applicant for \"(Senior) Fullstack Developer, ReactJS & .NET\" is available for review.', 'application', 4, 0, '2025-04-28 17:53:48'),
(58, 3, 'New Application Available', 'A new application from Nguyen Van A for \"Software Engineer (Backend Skill)\" is available for review.', 'application', 12, 0, '2025-04-28 17:53:58'),
(59, 3, 'New Application Available', 'A new application from Nguyen Van A for \"Software Engineer (Backend Skill)\" is available for review.', 'application', 12, 0, '2025-04-28 18:07:05'),
(60, 3, 'New Application Available', 'A new application from Nguyen Van A for \"Software Engineer (Backend Skill)\" is available for review.', 'application', 12, 0, '2025-04-28 18:14:28'),
(61, 3, 'New Application Available', 'A new application from Nguyen Van A for \"Software Engineer (Backend Skill)\" is available for review.', 'application', 12, 0, '2025-04-28 18:20:01'),
(62, 3, 'Job Post Approved', 'Your job posting \"Human Resources Intern\" has been approved and is now visible to job seekers.', 'approval', 19, 0, '2025-04-28 18:42:29'),
(63, 3, 'Job Post Rejected', 'Your job posting \"Human Resources Intern\" has been rejected. Please review and update it before resubmitting.', '', 19, 0, '2025-04-28 18:44:34'),
(64, 3, 'New Application Available', 'A new application from Nguyen Van A for \"Software Engineer (Backend Skill)\" is available for review.', 'application', 12, 0, '2025-04-28 18:55:08');
